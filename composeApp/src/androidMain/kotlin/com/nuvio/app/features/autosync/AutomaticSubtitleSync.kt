...
internal object AutomaticSubtitleSync {
    ...
    suspend fun findTimelineRetime(
        ...
        val aggressiveMode = effectiveAggressiveMode(
            operatorSettingsVisible = com.nuvio.app.core.build.ApachiyProductSettings.operatorSettingsVisible,
            storedAggressive = AutoSyncPreferencesRepository.aggressiveMode.value,
        )
    ...
    private fun preparedReferenceActivity(
